...
public class CrianzaVistaPrincipal extends JFrame {
	...
	public void Dibuja() {
		super.paint(g);
		g.drawImage(Rutinas.AjustarImagen("/Users/abrahamberrelleza/Library/Mobile Documents/com~apple~CloudDocs/ProyectoCrias/ganado.png", getWidth(), getHeight()).getImage(), 1, 45, null);
		repaint();
	}
